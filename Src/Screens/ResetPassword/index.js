    ...
    render() {
        return (
            <View style={styles.Container}>
                ...
                {/* Forgot header */}
                <View style={{ height: Deviceheight / 7, width: Devicewidth / 1.2, alignItems: 'center', justifyContent: 'center', marginBottom: 25 }}>
                    <View style={{
                        flexDirection: "row",
                        alignItems: "center", justifyContent: "center", marginRight: 29
                    }}>
                        ...
                        <Text style={{ color: "#fff", fontSize: 28, textAlign: 'center' }}>  Reset Password?</Text>
                    </View>
                    <Text style={{ color: "#fff", fontSize: 12, width: Devicewidth / 1.4, textAlign: "left", marginTop: 20 }}>E-mail address verified! Set a new password</Text>
                ...
                <TouchableOpacity
                    ...
                    <Text style={{ color: "#fff", fontSize: 12, textAlign: 'center', }}>RESET PASSWORD</Text>
                </TouchableOpacity>
